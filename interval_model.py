...
for place in places:
    ...
    for i in range(1, 31):
        for type in types:
            ...
            score = math.fabs(sklearn.metrics.log_loss(y, y_pred_init))
            leftmost_best_score = 10000000000
            ...
            while leftmost_best_score >= score:
                ...
                score1 = math.fabs(sklearn.metrics.log_loss(y, y_pred1))
            ...
            border_point = (max_point + min_point) / 2
            score = math.fabs(sklearn.metrics.log_loss(y, y_pred_init))
            rightmost_best_score = 10000000000
            ...
            while rightmost_best_score >= score:
                ...
                score2 = math.fabs(sklearn.metrics.log_loss(y, y_pred2))
...
with open('interval_model_log_loss.csv', 'w') as csvfile:
